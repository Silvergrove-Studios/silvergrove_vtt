...
| P3 | a hex battle map with no context | The adventure opens on a painted regional map, *The Vale of Thornwick*; the chapel's battle map comes with the fight. |
...
| P5 | *Next* not addressed to the DM | *Your next step · only you see this*, in the DM's colour: invite players, start the session, then read *Start here*. Gone during a fight. |
...
2. Hexmap → *Run a game* → the adventure's card → *Start*.
...
4. **The road.** Drag the party (★) west. On the ford's and the chapel's
   ...
   them. Brother Aldous's hut is south of the road.
