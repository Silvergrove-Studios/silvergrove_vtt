...
func test_web_server() -> void:
	...
	check(WebServer.address_rank("10.211.55.2") == 1 and WebServer.address_rank("10.37.129.2") == 1, "Parallels' own subnets are a virtual machine's, not the home network")
