...
const SUITES := ["hex_grid", "document", "json_schema", "expr", "pdf", "exporters", "packs_tools", "layers_lighting",
	"ui", "ui_views", "shell", "encounter", "table", "player", "net", "web", "fuzz", "rules_kernel", "rules_lua", "rules_plugins", "rules_turns", "rules_views", "rules_content", "rules_map", "rules_campaign", "rules_perf", "rules_sandbox"]
